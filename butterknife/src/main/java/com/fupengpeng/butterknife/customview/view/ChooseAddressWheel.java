package com.fupengpeng.butterknife.customview.view;
...
import com.fupengpeng.butterknife.customview.view.adapter.AreaWheelAdapter;
import com.fupengpeng.butterknife.customview.view.adapter.CityWheelAdapter;
import com.fupengpeng.butterknife.customview.view.adapter.ProvinceWheelAdapter;
import com.fupengpeng.butterknife.customview.view.listener.OnAddressChangeListener;
import com.fupengpeng.butterknife.customview.view.wheelview.OnWheelChangedListener;
import com.fupengpeng.butterknife.customview.view.wheelview.WheelView;
import com.fupengpeng.butterknife.entity.AreaEntity;
import com.fupengpeng.butterknife.entity.CityEntity;
import com.fupengpeng.butterknife.entity.ProvinceEntity;
...
public class ChooseAddressWheel implements OnWheelChangedListener {
    ...
    private void initPopupWindow() {
        popupWindow = new PopupWindow(parentView, WindowManager.LayoutParams.MATCH_PARENT,
                (int) (Utils.getScreenHeight(context) * (2.0 / 5)));
    ...
    public void confirm() {
        if (onAddressChangeListener != null) {
            ...
            if (etAddress.getText().toString() != null && etAddress.getText().toString().length() > 0) {
                address = etAddress.getText().toString().trim();
            }

            onAddressChangeListener.onAddressChange(provinceName, cityName, areaName, address);
        }
        cancel();
    }
